...
// led[0] is a serie of 5 LED's
  // led[1] is a serie of 5 LED's
   // led[2] is a serie of 5 LED's
    // led[3] is a serie of 1 LED's !!!!!!!!
	...
	if ( bitCounter > 5 ) 
	{
	  ...
	  if ( counter%4 == 1 ) leds[0] = ~( 0B00000001 << (bitCounter++) ) ;//row 1, green row off when 0xff
	  if ( counter%4 == 2 ) leds[1] = ~( 0B00000001 << (bitCounter++) ) ;
	  if ( counter%4 == 3 ) leds[2] = ~( 0B00000001 << (bitCounter++) ) ;
	  if ( counter%4 == 0 ) leds[3] = ~( 0B00000001 << (bitCounter++) ) ;
